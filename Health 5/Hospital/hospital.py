...
dataframe= pd.read_csv("hospital.csv")
...
filtered_df = dataframe.loc[(dataframe['VAR']=="HOSPTHOS")]
filtered_df = filtered_df.loc[(filtered_df['UNIT']=="NBMILPNB")]
...
plt.title('Hospital per Million Population')
...
plt.savefig("hospitals"+".jpg", dpi=500)
plt.show()
