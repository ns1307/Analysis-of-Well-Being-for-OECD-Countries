...
filtered_df = dataframe.loc[(dataframe['VAR']=="CANCTOCA")]
filtered_df = filtered_df.loc[(filtered_df['UNIT']=="PERCMTTX")]
...
plt.xlabel("Year")
plt.ylabel("Cancer Patients")
plt.title('Cancer Patients per 100 000 population')
plt.legend(countries,prop={'size': 5})

plt.tight_layout()

plt.savefig("Cancer_Patients"+".jpg", dpi=500)
plt.show()
