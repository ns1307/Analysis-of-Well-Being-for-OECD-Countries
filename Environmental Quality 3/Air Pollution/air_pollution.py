...
filtered_df = dataframe.loc[(dataframe['VAR']=="PWM_EX")]
...
for i in range(len(countries)):
    ...
    best_degree=5 #below comment line is tried, best result is with 6th degree
    """"best_degree=3
    best_score=0
...
"""
    ...
    title="Mean population exposure to PM2.5 for "+ country
    plt.title(title)
    plt.xlabel("Year")
