...
dataframe= pd.read_csv("home_rent_room_individual.csv")
...
no_data_countries= []
new_colors=[]
filtered_df = dataframe.loc[(dataframe['VAR']=="HOUSE_COST_SH")]
...
title="Similarity Matrix Home Rent"
plt.title(title)
...
title="Number of Comparisons Home Rent"
plt.title(title)
plt.xlabel("Countries")
plt.ylabel("Countries")
plt.savefig(title+".png", dpi=500)
...
plt.title('Percentage of House Rental Expense in Total House Income')
...
plt.savefig("home_rent_percentages"+".jpg", dpi=500)
plt.show()
