...
dataframe= pd.read_csv("job_quality(total).csv")
...
def check_similarity(array1,array2):
     ...
     for ind in range(len(array1)):
         value1=array1[ind]
         value2=array2[ind]
         if value1!=None and value2!=None:#if values are not empty
     ...
     if cosine!= cosine or cosine==None:
         new_array1=[]
         new_array2=[]
         for ind in range(len(array1)):
             value1=array1[ind]
             value2=array2[ind]
             if value1!=None: #if values are not empty
                 new_array1.append(value1)
             if  value2!=None:
                 new_array2.append(value2)
     if len(new_array1)==0 or len(new_array2)==0:
         cosine=0
     else:
         avg1=sum(new_array1)/len(new_array1)
         avg2=sum(new_array2)/len(new_array2)
         cosine= 1 - abs(abs(avg1 - avg2) / (avg1 + avg2))
